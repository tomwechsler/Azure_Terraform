...
resource "azurerm_virtual_network" "vnet" {
    name                = "vnet-${local.system}-westeurope-001"
...
resource "azurerm_subnet" "subnet" {
  name                 = "snet-${local.system}-westeurope-001 "
  resource_group_name  = azurerm_resource_group.rg.name
...
resource "azurerm_public_ip" "publicip" {
  name                = "pip-${local.system}-dev-westeurope-001"
  location            = "westeurope"
  resource_group_name = azurerm_resource_group.rg.name
...
#https://learn.hashicorp.com/tutorials/terraform/azure-dependency
